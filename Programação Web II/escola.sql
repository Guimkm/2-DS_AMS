...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10/08/2026 às 19:39
...
('10012', 'Richardson S. P. Campeao', 'Rua Tricolor, 433', 'São Paulo', '03'),
...
ALTER TABLE `cursos`
  ...
  ADD KEY `CodDisc` (`CodDisc1`,`CodDisc2`,`CodDisc3`) USING BTREE;
...
--
ALTER TABLE `alunos`
  ADD CONSTRAINT `alunos_ibfk_1` FOREIGN KEY (`CodCurso`) REFERENCES `cursos` (`codcurso`);
COMMIT;
