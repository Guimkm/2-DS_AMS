...
<div class="formulario">
    ...
    <form action="processa.php" method="POST" id="form"> 
        ...
        <p class="email"><label for="idEmail"><?= "E-mail"?></label><br><input type="text" name="email" id="idEmail" placeholder="Digite seu e-mail"></p>
        ...
        <p class="mens"><label for="idMens"><?= "Mensagem"?></label><br><textarea name="mens" id="idMens" cols="95" rows="10" placeholder="Digite sua mensagem"></textarea></p>
